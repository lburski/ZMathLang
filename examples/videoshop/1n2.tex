...
\where
\draline{PRE6}{\text{\expression{\term{p?} \notin \set{members}}}}\\
\draline{O3}{\text{\expression{\term{outcome!} = \term{notMember}}}}
\end{schema}}
...
\text{\declaration{\term{outcome!}: \expression{MESSAGE}}}
\where
\draline{PRE7}{\text{\expression{\term{t?} \notin
 \set{\dom \set{stockLevel}}}}}\\
\draline{O4}{\text{\expression{\term{outcome!} = \term{notInStock}}}}
\end{schema}}
...
\text{\declaration{\term{outcome!}: \expression{MESSAGE}}}
\where
\draline{PRE8}{\text{\expression{\term{\set{stockLevel}~\term{t?}}=
 \term{\# (\set{\set{rented} \rres \set{\{\term{t?}\}}})}}}}\\
\draline{O5}{\text{\expression{\term{outcome!} = \term{allCopiesOut}}}}
\end{schema}}
...
\text{\declaration{\term{outcome!}: \expression{MESSAGE}}}
\where
\draline{PRE9}{\text{\expression{\term{\term{p?} \mapsto \term{t?}}
 \in \set{rented}}}}\\
\draline{O6}{\text{\expression{\term{outcome!} =
 \term{alreadyRented}}}}
\end{schema}}
...
\text{\declaration{\term{outcome!}: \expression{MESSAGE}}}
\where
\draline{PRE10}{\text{\expression{\term{\term{\set{stockLevel}~\term{t?}} +
 \term{change?}} \leq \term{0}}}}\\
\draline{O7}{\text{\expression{\term{outcome!} = \term{nonPosStockLevel}}}}
\end{schema}}
...
\draline{O8}{\text{\expression{\term{outcome!} = \term{tooManyRented}}}}
\end{schema}}
...
\text{\declaration{\term{outcome!}: \expression{MESSAGE}}}
\where
\draline{PRE12}{\text{\expression{\term{t?} \in \set{\ran \set{rented}}}}}\\
\draline{O9}{\text{\expression{\term{outcome!} = \term{stillRented}}}}
\end{schema}}
