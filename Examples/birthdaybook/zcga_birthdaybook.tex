...
\begin{zed} 
    \text{RAddBirthday} ==\\ \text{\expression{(\text{AddBirthday} \land \text{Success})\\  \lor \text{AlreadyKnown}}} \\
    \text{RFindBirthday} ==\\ \text{\expression{(\text{FindBirthday} \land \text{Success}) \lor \text{NotKnown}}} \\
\end{zed}
