...
\begin{zed} 
    \draline{TS1}{\text{RAddBirthday} == \text{\expression{(\text{AddBirthday} \land \text{Success})\\  \lor \text{AlreadyKnown}}}} \\
   \draline{TS2}{\text{RFindBirthday} ==\\ \text{\expression(\text{FindBirthday} \land \text{Success}) \lor \text{NotKnown}}} \\
\end{zed}
